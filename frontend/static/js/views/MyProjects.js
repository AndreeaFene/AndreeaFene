...
export default class extends AbstractView {
    ...
    async getHtml() {
        ...
        <h1>My Projects</h1>
            ...
            <img id="ImgMyProjects" src="/static/images/home1_1.png" alt="Andreea">
            </div>
            <div class="SubProject">
            <p><a href="https://github.com/AndreeaFene/SIIT_Andreea_Fenesanu/tree/main/06_week_homework" download>Player Box Game</a></p>
            <img id="ImgMyProjects" src="/static/images/home3.png" alt="Andreea">
            </div>
            <div class="SubProject">
            ...
            <img id="ImgMyProjects" src="/static/images/home7.png" alt="Andreea">
            </div>
            <footer>
